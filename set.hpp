...
/*   Updated: 2022/06/10 16:11:01 by gasselin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 			typedef	typename	ft::BST<value_type, Key, Compare>::iterator			iterator;
// 			typedef	typename	ft::BST<value_type, Key, Compare>::const_iterator	const_iterator;
// 			typedef				ft::reverse_iterator<iterator, set<Key, Compare, Alloc> > 		reverse_iterator;
// 			typedef				ft::reverse_iterator<const_iterator, set<Key, Compare, Alloc> > const_reverse_iterator;

// 		private:
// 			Alloc					 		_alloc;
// 			Compare							_comp;
// 			BST<value_type, Key, Compare>	_bst;
